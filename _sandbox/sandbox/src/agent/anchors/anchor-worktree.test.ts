...
// Stands in for git: `dirty` names repos with uncommitted changes, `broken` ones that throw. The rev-parse result
// reflects whether a commit happened, so assertions can tell a fresh pin from a stale HEAD.
