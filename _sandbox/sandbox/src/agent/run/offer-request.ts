...
// two live runs.
export const liveRequestRun = (conversationId: string | undefined): LiveCard | undefined => {
...
export const raiseRequest = async <K extends AgentReply["kind"]>(deps: Pick<CardDeps, "observe">, run: LiveCard, card: Card<K>): Promise<SettledCard<K>> => {
