...
// store/evolution/state-registry.ts from, and the registry's test checks it against. Never shipped.
...
const SKIPPED = new Set(["store/evolution/documents.ts", "store/evolution/state-steps.ts", "store/evolution/state-registry.ts"]);
