...
import { areasCover } from "../auth/fleet-scope.js";
...
// Whether the work may change hands to this member at all: the areas it was born with must be among the ones they
