 ...
 * precedent) and image-packs/cursor.Dockerfile installs the same pin back on the OWNER'S machine.
 *
...
// Where image-packs/cursor.Dockerfile installs it. Overridable so a test can point at a fixture tree without a pack,
 ...
 * (image-packs/cursor.Dockerfile installs into `<root>/node_modules/@cursor/sdk`), and the entry is taken from its
