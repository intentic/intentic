...
/* The frame that did not exist, and the silence it left: a wake that errored closed the stream with `done` alone. */
...
/* The reason is the OWNER's: their billing, their credentials, their guard script's stderr. */
