...
// Nothing else may be added; every git and tmux the daemon runs forks from this address space, so it must stay minimal.
...
export interface ForkRequest {
    ...
    // Absent runs it in this process's own working directory.
    readonly cwd?: string;
...
if (send === undefined) {
    throw new Error("the forker started without an IPC channel");
}
