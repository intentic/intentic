...
// The element and identity suites need a DOM; the transport parser doesn't care, and one environment for the
// package beats a per-file annotation. It overrides the shared budgets' `node`, which is the only thing this
