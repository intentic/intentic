/* WHICH BUILD OF THIS AGENT IS RUNNING — reported in the machine report, so a computer running a five-day-old
 * agent is a fact on the Computers row rather than a mystery about why sync behaves unlike the docs.
 *
...
export const SYNC_VERSION: string = typeof INTENTIC_AGENT_VERSION === "string" ? INTENTIC_AGENT_VERSION : "0.0.0";
