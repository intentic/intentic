...
// cgroup), an unset variable leaves bun its default of one worker per core.
const parallel = process.env.TEST_WORKERS ? `--parallel=${process.env.TEST_WORKERS}` : "--parallel";
