...
export const scenario: Scenario = {
    // Named for what it measures since 71dbfb714 removed the memo it was written for: a count with nothing kept, where a
    // line appended past a counted save costs the walk of both sides again, bar the lines they open with.
    what: "a count of a save with one line appended (codeLineStat, nothing kept): the lines both sides open with are walked once",
    setup: async () => {
