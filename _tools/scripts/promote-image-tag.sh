...
# desktop-setup tiers, by verify-images-public.sh, and by the connect-host.ps1 a Windows user runs.
...
# version. Those two still spell it inline; folding them onto this script is a follow-up, not a drive-by on the
# rollback lever.
set -euo pipefail
