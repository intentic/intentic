...
// Staged, unstaged and untracked alike, a rename by its new name (lib/git.mjs). `undefined` means git could
// not answer, which widens the closure below to everything rather than narrowing it to nothing.
