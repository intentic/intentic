...
export const CHECKS = [
    ...
    { id: "release-notes", file: "release-headings.mjs", needs: "checkout", about: "the release body: headings spelled the same by writer and parsers, built from a non-empty range" },
    ...
    { id: "layout", file: "layout.mjs", needs: "checkout", about: "no ghost directories, no over-full ones, no twin or colliding names, no dead ones (ratcheted)" },
    { id: "md-links", file: "md-links.mjs", needs: "checkout", about: "every relative link in the documentation resolves" },
    { id: "alias-targets", file: "alias-targets.mjs", needs: "checkout", about: "every resolver alias points at a path that exists" },
