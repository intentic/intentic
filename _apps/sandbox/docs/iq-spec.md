...
iq: sym — 4 symbols · showing 4/4
  WorkspaceSearchQuerySchema   const   _libs/sandbox-contract/src/schemas.ts:215
  WorkspaceSearchMatchSchema   const   _libs/sandbox-contract/src/schemas.ts:219
  WorkspaceSearchFileSchema    const   _libs/sandbox-contract/src/schemas.ts:223
  WorkspaceSearchSchema        const   _libs/sandbox-contract/src/schemas.ts:226
```
