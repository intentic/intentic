...
// A TurnStream that paints the model's text into Discord as it streams: the reply grows in one message, spilling
...
export const createDiscordStream = (channel: StreamChannel, onError: (error: unknown) => void): TurnStream => {
    let buffer = "";
