...
import { AGENT_SESSION_PREFIX, JOB_SESSION_PREFIX } from "../system/terminal-session.js";
...
const defaultRunner: ProcessRunner = {
    launch: async (session, spec) => {
        ...
        // The trailing ":" is load-bearing: send-keys takes a target-PANE, and tmux (3.3a) never resolves a bare
