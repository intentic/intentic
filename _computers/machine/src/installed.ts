 ...
 * on serving the old one. That is exactly how a computer sat several releases behind with a current binary on
 * disk: its Computers row printed the running build as though it were the agent's version, and `upgrade`
