...
// pairing list in a file of its OWN beside the computer half's (see the shared config for why the two never
 ...
 * and it matters MORE in the merged agent: the resident loop's pid also vouches for the computer half, so a
