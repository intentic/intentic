 ...
 *
 * Two agents ship to a user's machine, `@intentic/machine` (the sandbox's agent works on this computer, and
...
export { isProcessAlive, livePid, pidFileBody, spawnDetached } from "./detached.js";
