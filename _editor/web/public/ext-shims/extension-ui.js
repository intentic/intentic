...
export const WorkerCallError = m["WorkerCallError"];
export const activeLocale = m["activeLocale"];
export const appLink = m["appLink"];
export const browserOwnsClick = m["browserOwnsClick"];
export const clipboardOf = m["clipboardOf"];
export const createWorkerCall = m["createWorkerCall"];
export const diffSequence = m["diffSequence"];
export const errorMessage = m["errorMessage"];
export const extensionT = m["extensionT"];
...
export const pairEdits = m["pairEdits"];
export const seriesColor = m["seriesColor"];
export const serveWorkerCall = m["serveWorkerCall"];
export const similarity = m["similarity"];
export const sinceOf = m["sinceOf"];
export const timeAgo = m["timeAgo"];
export const timeWindowWords = m["timeWindowWords"];
export const timeWindows = m["timeWindows"];
...
export const wordDiff = m["wordDiff"];
