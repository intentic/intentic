...
vi.mock("../../features/sandbox/client/sandboxClient", () => ({ sandboxRequest: vi.fn(async () => new Response()) }));
vi.mock("../../features/auth/useAuth", () => ({ useAuth: () => ({ user: ref({ id: `u`, email: `Me@x.com`, name: `Me`, image: null }) }) }));
