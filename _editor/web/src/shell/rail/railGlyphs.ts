 ...
 * Drawn for 18–24px on a 24-unit grid. Keep the silhouette specific to the section, leave at least
 * two units between strokes, and use solid cuts only where an outlined detail would close up.
 * Keys are view identities, independent of the generic icon an extension happens to declare. */
interface RailGlyph {
    readonly outline: string;
    readonly solid?: string;
}

export const RAIL_GLYPHS: Readonly<Record<string, RailGlyph>> = {
    ...
    maintenance: {
        outline: `m7 16 1-5L18 1l4 4-10 10Z M14 5l4 4 M3 14v7h16v-7 M5 17l2-1`,
    },
    workflows: {
    ...
    documentation: {
        outline: `M12 6 8 4H3v15h5l4 2 4-2h5V4h-5Z M12 6v15 M6 9h2 M16 9h2 M6 13h2 M16 13h2`,
    },
