...
import { Button, CopyButton, type NoticeModel, Notice, RowGroup, ui } from "@intentic/ui";
        ...
        <div class="flex flex-col gap-3 px-4.5 py-4">
            ...
            <div class="ui-field">
                ...
                <span class="text-2xs text-subtle">
                    The publisher half of an extension id, or a domain you control. A dotted name proves itself from its own well-known path instead
                    of from a repository.
                </span>
            </div>
                ...
                <div class="flex flex-col gap-3 border-t border-line-subtle pt-3">
                    ...
                    <template v-else-if="domainLane">
                        <p class="text-sm text-muted">
                            Only someone who controls <span class="font-medium text-content">{{ challenge.publisher }}</span> could serve a file at
                            its well-known path. That's the proof. Serve this exact line as plain text at
                    ...
                    <template v-else-if="target">
                        ...
                        <p class="text-sm text-muted">
                            ...
                            <span class="font-medium text-content">{{ challenge.publisher }}</span> publishes from could put a file in one. That's the
                            proof.
