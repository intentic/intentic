...
vi.mock(`./version/useSandboxVersion`, () => ({
...
vi.mock(`./version/SandboxUpdateCard.vue`, () => ({ default: defineComponent({ render: () => null }) }));
vi.mock(`./version/SandboxBehindCard.vue`, () => ({ default: defineComponent({ render: () => null }) }));
