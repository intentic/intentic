...
const RETENTION_OPTIONS = computed(() => [
    ...
    { label: t(`sandbox.agentFinishedWork.never`), value: `0` },
]);
</script>
...
<template>
    <RowGroup :label="t(`sandbox.agentFinishedWork.finishedWork`)">
        ...
        <Row
            icon="download"
            :title="t(`sandbox.agentFinishedWork.landFinishedWorkAutomatically`)"
        ...
        <Row
            icon="history"
            :title="t(`sandbox.agentFinishedWork.saveVersionAcceptedWork`)"
            :description="t(`sandbox.agentFinishedWork.commitWhatEachLanded`)"
        >
            <template #control>
