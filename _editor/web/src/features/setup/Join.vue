...
import MembershipOffer from "../settings/membership/MembershipOffer.vue";
import { formatCredits as n, hasReturned, joinLabel, resetsAtLocal } from "../settings/membership/creditMeter";
