    ...
    <div class="flex flex-col gap-0.5 p-1">
        ...
        <template v-if="empty">
            ...
            >
                ...
                <span class="text-sm text-content md:text-xs">{{ t(`chat.words.setUpPersona`) }}</span>
            </RouterLink>
        </template>
        ...
        <template v-else>
            ...
            >
                ...
                <span class="flex min-w-0 flex-col">
                    <span class="text-sm text-content md:text-xs">{{ t(`chat.words.anyone`) }}</span>
            ...
            >
                ...
                <span class="text-2xs text-subtle">{{ t(`chat.words.managePersonas`) }}</span>
            </RouterLink>
        </template>
    </div>
</template>
