 ...
 * bytes themselves: comes from the injected surface (chatToolSurface.ts) rather than from the app's own
...
/* Everything this card can lead to, from whoever is showing it (see chatToolSurface.ts). In the app that is the
 ...
 * load the page. Hand-written rather than a <RouterLink> for the reason chatToolSurface.ts gives. */
