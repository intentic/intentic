 ...
 *
 * Everything that leads off it comes from the injected surface (chatToolSurface.ts) rather than from the app's
 ...
 * (chatToolSurface.ts), so in the app the links are there and on a shared page the paths are plain text.
 *
