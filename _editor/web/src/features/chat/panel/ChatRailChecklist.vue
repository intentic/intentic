...
<!-- Above plan headroom because this is about now and headroom is about later; both are asides to the transcript. -->
    <section v-if="todos" class="flex max-h-[45%] shrink-0 flex-col gap-2 px-3 pt-3 pb-4" aria-label="This chat's checklist">
        <div class="flex items-baseline gap-1.5">
            <span class="min-w-0 flex-1 truncate text-2xs font-medium text-content">Checklist</span>
