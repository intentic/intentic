...
describe(`the strip's selection`, () => {
    it.each<[string, StripSelection, SelectionEvent, StripSelection]>([
        [`ranges from the anchor`, picked([], 3), { kind: `range`, groups, at: 1, active: 0 }, picked([`b`, `c`, `d`], 3)],
        [
            `ranges from the active group with no anchor`,
            NO_SELECTION,
            { kind: `range`, groups, at: 3, active: 1 },
            picked([`b`, `c`, `d`], undefined),
        ],
        [`ranges over the pressed group alone with neither`, NO_SELECTION, { kind: `range`, groups, at: 2, active: -1 }, picked([`c`], undefined)],
        [`adds a group on a toggle, anchoring there`, picked([`a`], 0), { kind: `toggle`, groups, at: 1, active: 0 }, picked([`a`, `b`], 1)],
        [`drops a selected group on a toggle`, picked([`a`, `b`], 0), { kind: `toggle`, groups, at: 1, active: 0 }, picked([`a`], 1)],
        [`clears on a plain press, anchoring there`, picked([`a`, `b`], 0), { kind: `single`, groups, at: 2, active: 0 }, picked([], 2)],
