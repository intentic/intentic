...
// One URL per picture or video the home draws, shared by the tiles and the quick look, so a hover never re-reads what a
...
// Held URLs. Generous because each is a few kilobytes now, and the home only draws what is on screen: scrolling back up
