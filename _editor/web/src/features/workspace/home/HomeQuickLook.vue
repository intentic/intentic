...
<template>
    <Teleport to="body">
        <Transition enter-active-class="ui-home-move" :enter-from-class="enterFrom" leave-active-class="ui-home-move" leave-to-class="opacity-0">
            <div
                v-if="entry !== undefined && plan !== undefined"
                ref="box"
                class="ui-home-move pointer-events-none fixed z-[1000] w-[min(36rem,calc(100vw-2rem))] overflow-hidden rounded-lg border border-line bg-card shadow-lg"
                :style="style"
                role="tooltip"
            >
