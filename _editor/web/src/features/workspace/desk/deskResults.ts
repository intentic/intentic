...
// What the desk shows for a query: matches under the open folder, flat, each knowing the folder it sits in. The tree
// answers the same query over the whole workspace; the desk answers it where the reader is. Pure, no framework code.
