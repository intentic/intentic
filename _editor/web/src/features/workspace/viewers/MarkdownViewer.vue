    ...
    <div ref="root" class="flex h-full min-h-0 flex-col">
        ...
        <Teleport defer :to="`#${viewerActionsTarget(scope)}`">
            ...
            <Button
                ...
                :text="true"
                class="min-w-0"
                v-tooltip.bottom="t(`workspace.words.outline`)"
        ...
        <ResponsiveOverlay v-model="overlayOpen" :anchor="opener" :header="t(`workspace.words.outline`)" panel-class="max-h-[60vh] w-72 p-2">
