...
const developer = (): Vocabulary => ({
    ...
    land: t(`shared.landNow`),
    landing: t(`shared.landing`),
    landAgain: t(`shared.landAgain`),
    ...
    clearYours: t(`shared.commitStashYours`),
