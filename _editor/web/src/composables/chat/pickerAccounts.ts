import { type AgentHarness, type AgentProvider, type KeyedProvider } from "@intentic/sandbox-contract";
...
import { formatAge, liveUsage, planHeadroom, refusalNote, usagePercent } from "./usageStatus";
...
export const usePickerAccounts = (provider: Ref<AgentProvider>, harness: Ref<AgentHarness>) => {
    ...
    return { accounts, accountRows, routedRows, unplacedRefusal, harnessOptions, harnessChoosable, measuredAt, measuring, remeasureLabel, remeasure, hasContent };
};
