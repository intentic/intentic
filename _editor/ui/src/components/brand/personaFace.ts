...
// A glyph is one shape; a face is a dozen, and in a glyph's box they collapse — drawn 22px wide, a clay mouth
// renders about two CSS px tall. So a face gets its own box, named by what the surface is
