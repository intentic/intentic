...
`_shared/sandbox-contract/src/schemas.ts`. The web app's `ChatMessageView.test.ts` mocked that package with a
...
_shared/registry, sandbox-contract, sandbox-openapi, webchat-widget, workspace-ignore, workspace-setup
