...
[services-admission-design.md](../design/services-admission-design.md), which covers how a listing is admitted; this
...
[service-offer.ts](../../_sandbox/sandbox/src/platform/pool/service-offer.ts)). This is the strongest part of the
...
- **The spend gate.** x402 puts a funded wallet in the agent's hands, which is precisely the failure mode
  ...
  [service-offer.ts](../../_sandbox/sandbox/src/platform/pool/service-offer.ts) and the gates' daily-ceiling
