...
[services-integration-snowball.md](../audits/services-integration-snowball.md) (why supply is the scarce side) and
[services-admission-design.md](../design/services-admission-design.md) (how a listing gets in).
...
| The approval page | [ApproveRun.vue](../../_editor/web/src/features/setup/ApproveRun.vue) + `pool.offer` / `pool.settleOffer` |
| Buying without a sandbox | [Join.vue](../../_editor/web/src/features/setup/Join.vue), [Connect.vue](../../_editor/web/src/features/setup/Connect.vue) |
...
The offer itself is one component ([MembershipOffer.vue](../../_editor/web/src/features/settings/membership/MembershipOffer.vue))
