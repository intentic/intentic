...
| **AI editors** | Cursor, Windsurf, VS Code + Copilot, Zed, JetBrains AI | *keep yours* | Different primary operator: they put the human at the keyboard. Composes for real via desktop sync (`_computers/machine/`) and `@intentic/acp-bridge`, not diplomatically. |
