...
Your repo's CI runs, with a button to have an agent fix a failure.
...
A red build is a task. Seeing it and starting the fix should be the same click.

```dag
{ "title": "Its neighbours",
  "direction": "LR",
  "nodes": [
    {"id": "_extensions/pipelines", "label": "pipelines", "note": "this package", "accent": "3"},
  ...
  "edges": [
    {"from": "_extensions/pipelines", "to": "_libs/extension-api"},
    {"from": "_extensions/pipelines", "to": "_libs/extension-ui"},
    {"from": "_extensions/pipelines", "to": "_libs/sandbox-contract"},
    {"from": "_extensions/pipelines", "to": "_tools/tsconfig", "dashed": true},
    {"from": "_apps/web", "to": "_extensions/pipelines"}
  ] }
```
...
{ "title": "Size within Extensions (10 of 15)",
  "items": [
    ...
    {"label": "pipelines (this one)", "value": 1545, "display": "1.5k", "accent": "3"},
...
One sidebar tile, reading GitHub or GitLab.
