...
The sandbox's log tail, on a screen.

```stats
{ "items": [
    {"label": "Lines", "value": "274"},
    {"label": "Files", "value": "6"},
...
When the box misbehaves, the logs are the first place to look, and asking someone to SSH in is a poor answer.

```dag
{ "title": "Its neighbours",
  "direction": "LR",
  "nodes": [
    {"id": "_extensions/logs", "label": "logs", "note": "this package", "accent": "3"},
  ...
  "edges": [
    {"from": "_extensions/logs", "to": "_libs/extension-api"},
    {"from": "_extensions/logs", "to": "_libs/extension-ui"},
    {"from": "_extensions/logs", "to": "_libs/sandbox-contract"},
    {"from": "_extensions/logs", "to": "_tools/tsconfig", "dashed": true},
