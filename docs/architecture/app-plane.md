...
- [`contract.lock.json`](../../_shared/sandbox-contract/contract.lock.json) records the wire surface. [`contract-shrink.mjs`](../../_tools/checks/contract-shrink.mjs) refuses a change that removes or narrows part of it unless the commit declares the break.
