...
Retired: the desktop experiment's Rust shell.

```stats
{ "items": [
    {"label": "Lines", "value": "723"},
    {"label": "Files", "value": "9"},
...
Part of the same abandoned desktop attempt.
...
{ "title": "Size within Plumbing & retired code",
  "items": [
    ...
    {"label": "src-tauri (this one)", "value": 723, "display": "723", "accent": "neutral"},
