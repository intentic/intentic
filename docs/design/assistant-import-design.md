...
| `skills/<name>/SKILL.md` | `.intentic/config/skills/<name>/` + the agent's copy under `.agents/skills/<name>/` | `POST /skills`; frontmatter normalized to our two-key form, nested Hermes skills flattened |
