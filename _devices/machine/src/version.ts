/* WHICH BUILD OF THIS AGENT IS RUNNING, reported in the host hello frame and the machine report, so a device
 * running a five-day-old agent is a fact on the Devices row rather than a mystery about why it behaves unlike
 * the docs.
 *
