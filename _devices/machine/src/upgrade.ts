 ...
 * command. That is the right ceremony for ENROLLING a device and absurd for bumping a version, so nobody did
...
/* The published asset for THIS machine, the same URL, built the same way, that device.sh/sync.sh resolve.
 *
