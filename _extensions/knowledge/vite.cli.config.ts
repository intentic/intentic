 ...
 *
 * BUILT rather than hand-written as plain ESM (the intentic-docs precedent), because the vault engine it drives
 ...
 * it would show up as the agent and the panel disagreeing about what the vault says.
 *
