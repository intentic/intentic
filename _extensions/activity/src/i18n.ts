...
// This extension's words. The host mounts them under `ext.intentic.activity` and loads the reader's language before
// it calls `activate`, so a contribution's title is never briefly in the wrong one.
