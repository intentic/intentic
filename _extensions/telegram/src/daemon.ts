...
// daemon holds no Telegram connection itself — this process does — so every interaction with automations rides
...
export interface DaemonState {
    ...
    readonly connectors: ReadonlyArray<{ id: string; config: TelegramConnectorConfig }>;
}
