...
// widening sandbox.update's `image` to accept null in _shared/api-contract failed the route test here while
...
// which carries its own resolve options. `@intentic/*` is the platform scope (api-contract) and
