...
// key the behaviour is identical to the old single-instance path (the dir stays `_apps/api`).
...
// the template key. Everything else (e.g. `_libs/api-contract`, `_libs/prisma`) is shared infra that keeps
