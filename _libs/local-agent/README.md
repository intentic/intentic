...
| | what it does | uses |
| --- | --- | --- |
| [`@intentic/host`](../../_apps/host) | lets the sandbox's agent work on this computer | home, launcher, autostart, detached |
| [`@intentic/sync`](../../_apps/sync) | mirrors files and ports between machine and sandbox | home, launcher, autostart, detached |
| [`@intentic/acp-bridge`](../../_apps/acp-bridge) | lets an editor talk to the sandbox | home |
