...
import { UsageRollupQuerySchema, UsageRollupSchema } from "../schemas.js";
...
export const usageContract = {
    rollup: oc.route({ method: "GET", path: "/usage/rollup" }).input(UsageRollupQuerySchema).output(UsageRollupSchema),
};
