        ...
        differences: [
            {
                ...
                body: "Claude Code on the web runs each session in an Anthropic-managed VM and clones your repo into it. Anthropic documents the isolation and offers a self-hosted option. An intentic sandbox is always a container on your machine, and the platform holds only your identity and a URL.",
            },
            {
