...
export function buildSoftwareAppSchema() {
    return {
        ...
        featureList: [
            ...
            "Extensions: automations, Discord and Slack, a website Visitor chat, memory, pipelines",
        ],
        author: founderRef,
        publisher: orgRef,
        isPartOf: { "@id": WEBSITE_ID },
...
export function buildDeskAppSchema() {
    return {
        ...
        featureList: [
            ...
            "What changed in every document, shown before you accept it",
            "Every accepted change saved as a version you can go back to",
            "Connections to your mail, calendar, files and shop, with passwords kept on your computer",
            "Runs on a schedule or when a message arrives",
        ],
        author: founderRef,
        publisher: orgRef,
        isPartOf: { "@id": WEBSITE_ID },
