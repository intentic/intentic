...
<w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"><w:body>${paragraph(HEADING, `Heading1`)}${PARAGRAPHS.map((text) =>
    paragraph(text),
...
export const HANDOVER_DOCX: Uint8Array<ArrayBuffer> = new Uint8Array(
    zipSync({
