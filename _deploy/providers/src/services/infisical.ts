...
const infisicalSchema = serviceSchema.extend({
    // First signup becomes Infisical's admin; the seed hook claims it via bootstrap first.
    adminUser: z.string(),
    ...
    createComposeServiceProvider(
        {
            ...
            // Claims the fresh instance's admin from the host; idempotent, since an initialized instance answers 400.
